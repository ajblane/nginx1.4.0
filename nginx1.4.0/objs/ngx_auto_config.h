#define NGX_CONFIGURE " --prefix=/opt/nginx --sbin-path=/usr/sbin/nginx --conf-path=/opt/nginx/nginx.conf --pid-path=/var/run/nginx.pid --lock-path=/var/run/nginx.lock --with-http_ssl_module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 7.2.0 (Ubuntu 7.2.0-8ubuntu3) "
#endif
